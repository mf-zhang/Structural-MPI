...
class YTVISDatasetMapper:
    ...
    def __call__(self, dataset_dict):
        ...
        # print(dataset_dict.keys()) # dict_keys(['file_names', 'height', 'width', 'length', 'video_id', 'annotations']) one video
        ...
        print(dataset_dict['height'])
        print(dataset_dict['width'])
        print(dataset_dict['length'])
        print(dataset_dict['video_id'])
        print(len(dataset_dict['image']), dataset_dict['image'][0].shape, dataset_dict['image'][1].shape)
        print(dataset_dict['file_names'])
